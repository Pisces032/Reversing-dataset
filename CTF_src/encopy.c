...
int main() {
    ...
    const uint8_t pt[16]={0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07, 0x34,0x22};
    const uint8_t flag[16]={0xBA,0x97,0xDC,0xFD,0x3F,0xF4,0x31,0xA8,0xA2,0x9C,0x2F,0x35,0xD4,0x9E,0x47,0x17};
    uint8_t ct[16] = {0};     // 外部申请输出数据内存，用于加密后的数据
    uint8_t plain[25] = {0};  // 外部申请输出数据内存，用于解密后的数据
